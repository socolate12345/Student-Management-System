...
public class frmGiaoVien extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jtbTTGV.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Teacher ID", "Full name", "Email", "Course Teaching", "Date of Birth", "Address", "Gender", "Phone Number"
            }
        ) {
        ...
        jLabel9.setText("Course Teaching");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGap(35, 35, 35)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jcbgiangday, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 152, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jtfEmail, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 163, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addComponent(jtfMaGV, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 163, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    public boolean checkinfo() {
        ...
        if (!c.checkID(jtfMaGV.getText())) {
            JOptionPane.showMessageDialog(this, "Wrong ID format", "Input again", JOptionPane.ERROR_MESSAGE);
            jtfMaGV.setText("");
            jtfMaGV.requestFocus();
            return false;
        } else if (!c.checkSpace(jtfHoTen.getText()) || !c.check(jtfHoTen.getText())) {
            JOptionPane.showMessageDialog(this, "Wrong name format", "Input again", JOptionPane.ERROR_MESSAGE);
            jtfHoTen.setText("");
            jtfHoTen.requestFocus();
            return false;

        } else if (!c.checkSpace(jtfEmail.getText()) || !c.check(jtfEmail.getText())) {
            JOptionPane.showMessageDialog(this, "Wrong Email format", "Input again", JOptionPane.ERROR_MESSAGE);
            jtfEmail.setText("");
...
//            return false;
            ...
            JOptionPane.showMessageDialog(this, "Wrong Address format", "Input again", JOptionPane.ERROR_MESSAGE);
            jtfDiaChi.setText("");
            jtfDiaChi.requestFocus();
            return false;

        } else if (!c.checkSpace(jtfDienThoai.getText()) || !c.checkPhone(jtfDienThoai.getText())) {
            JOptionPane.showMessageDialog(this, "Wrong Phone format", "Input again", JOptionPane.ERROR_MESSAGE);
    ...
    private void jbAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbAddActionPerformed
        ...
        if (ngaysinh == null || ngaysinh.equals("") || !ngaysinh.matches(regexDDMMYYYY)) {
            JOptionPane.showMessageDialog(this, "Date of Birth format is wrong", "Input again", JOptionPane.ERROR_MESSAGE);
            jtfngaysinh.setText("");
            jtfngaysinh.requestFocus();
            return;
        } else {
    ...
    private void jbDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbDeleteActionPerformed
        int b = JOptionPane.showConfirmDialog(null, "Are you sure you want to delete this data?", "Notification", JOptionPane.YES_NO_OPTION);
