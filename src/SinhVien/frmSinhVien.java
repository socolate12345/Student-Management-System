...
public class frmSinhVien extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jcblop.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jcblopMouseClicked(evt);
            }
        });
        ...
        jtbTTSV.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Student ID", "Full name", "Class", "Education", "Date Of Birth", "Address", "Gender", "Phone Number"
            }
        ) {
    ...
    private void jbAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbAddActionPerformed
        ...
        if (ngaysinh == null || ngaysinh.equals("") || !ngaysinh.matches(regexDDMMYYYY)) {
            JOptionPane.showMessageDialog(this, "Error input Date of Birth", "Input again", JOptionPane.ERROR_MESSAGE);
        ...
        if (listCheck.size() > 0) {
            JOptionPane.showMessageDialog(this, "ID is duplicated. Check again", "Error", JOptionPane.ERROR_MESSAGE);
            jtfMaSV.setText("");
...
//        }
    ...
    private void jbUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbUpdateActionPerformed
        ...
        Date d = null;
        if (ngaysinh == null || ngaysinh.equals("") || !ngaysinh.matches(regexDDMMYYYY)) {
            JOptionPane.showMessageDialog(this, "Error Date of Birth", "Input again", JOptionPane.ERROR_MESSAGE);
            // JOptionPane.showMessageDialog(null, "Lỗi ngày sinh");
            jtfngaysinh.setText("");
            jtfngaysinh.requestFocus();
            return;
        ...
        if (b == JOptionPane.YES_OPTION) {
            try {
                ...
                new SinhVienDAO().deleteIDSinhVien(masv);
                  ...
                  JOptionPane.showMessageDialog(this, "This student has grade, delete this student's grade first", "Notification", JOptionPane.ERROR_MESSAGE);
            } catch (ClassNotFoundException ex) {
                  JOptionPane.showMessageDialog(this, "This student has grade, delete this student's grade first", "Notification", JOptionPane.ERROR_MESSAGE);
            }
    ...
    private void jcblopMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jcblopMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_jcblopMouseClicked
    ...
    public boolean checkinfo() {
        ...
        if (!c.checkID(jtfMaSV.getText())) {
            ...
            JOptionPane.showMessageDialog(this, "Input name wrong", "Input again", JOptionPane.ERROR_MESSAGE);
            jtfHoTen.setText("");
            jtfHoTen.requestFocus();
            return false;

        } else if (!c.checkSpace(jtfHeDaoTao.getText()) || !c.check(jtfHeDaoTao.getText())) {
            JOptionPane.showMessageDialog(this, "Check the education program again", "Input again", JOptionPane.ERROR_MESSAGE);
            jtfHeDaoTao.setText("");
...
//            return false;
            ...
            JOptionPane.showMessageDialog(this, "Input addresss wrong", "Input again", JOptionPane.ERROR_MESSAGE);
            jtfDiaChi.setText("");
            jtfDiaChi.requestFocus();
            return false;

        } else if (!c.checkSpace(jtfDienThoai.getText()) || !c.checkPhone(jtfDienThoai.getText())) {
            JOptionPane.showMessageDialog(this, "Input phone number wrong", "Input again", JOptionPane.ERROR_MESSAGE);
            jtfDienThoai.setText("");
