...
public class frmLopHoc extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jtbLop.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Class ID", "Class Name", "Department", "Course"
            }
        ) {
...
//        }
    ...
    public boolean checkinfo() {
        ...
        if (!c.checkID(jtfMaLop.getText())) {
            JOptionPane.showMessageDialog(this, "Input class ID wrong", "Input again", JOptionPane.ERROR_MESSAGE);
            jtfMaLop.setText("");
            jtfMaLop.requestFocus();
            return false;
        } else if (!c.checkSpace(jtfTenLop.getText()) || !c.check(jtfTenLop.getText())) {
            JOptionPane.showMessageDialog(this, "Input class wrong", "Input again", JOptionPane.ERROR_MESSAGE);
            jtfTenLop.setText("");
            jtfTenLop.requestFocus();
            return false;

        } else if (!c.checkSpace(jtfKhoaHoc.getText()) || !c.check(jtfKhoaHoc.getText())) {
            JOptionPane.showMessageDialog(this, "Error inputing course", "Input again", JOptionPane.ERROR_MESSAGE);
            jtfKhoaHoc.setText("");
