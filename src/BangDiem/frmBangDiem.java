...
public class frmBangDiem extends javax.swing.JPanel {
    ...
    public frmBangDiem() {
        try {
            ...
            dtm.addColumn("Numbers of Exams");
            dtm.addColumn("System");
            dtm.addColumn("Score");
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Num. of Examination");
        ...
        jrbTrangthai.setText("On/Off");
        jrbTrangthai.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jrbTrangthaiActionPerformed(evt);
            }
        });
    ...
    private void jbNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbNewActionPerformed
        ...
        if (diemsv > 10 || diemsv < 0) {
            JOptionPane.showMessageDialog(this, "Score has to be from 0 - 9. Please input again", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        if (lanthi == 0) {
            JOptionPane.showMessageDialog(this, "Exam attemps has to be greater than 0.Please input again", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        if (heso == 0) {
            JOptionPane.showMessageDialog(this, "Exam system has to be greater than 0.Please input again", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        if (result) {
            JOptionPane.showMessageDialog(this, "Data is duplicated, Please check again", "Error", JOptionPane.ERROR_MESSAGE);
        } else {
    ...
    public boolean checkinfo() {
        ...
        if (!c.checkSpace(jtfDiem.getText())) {
            JOptionPane.showMessageDialog(this, "Input score wrong", "Please input again", JOptionPane.ERROR_MESSAGE);
            jtfDiem.setText("");
    ...
    private void jrbTrangthaiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jrbTrangthaiActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jrbTrangthaiActionPerformed
