...
public class frmKhoa extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jtbKhoa.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Departmant ID", "Department Name", "Phone Number"
            }
        ));
    ...
    public boolean checkinfo() {
        ...
        if (!c.checkID(jtfMaKhoa.getText())) {
            JOptionPane.showMessageDialog(this, "Wrong Department ID", "Input again", JOptionPane.ERROR_MESSAGE);
            jtfMaKhoa.setText("");
            jtfMaKhoa.requestFocus();
            return false;
        } else if (!c.checkSpace(jtfTenKhoa.getText()) || !c.check(jtfTenKhoa.getText())) {
            JOptionPane.showMessageDialog(this, "Wrong Department name", "Input again", JOptionPane.ERROR_MESSAGE);
            jtfTenKhoa.setText("");
            jtfTenKhoa.requestFocus();
            return false;

        } else if (!c.checkSpace(jtfSDT.getText()) || !c.checkPhone(jtfSDT.getText())) {
            JOptionPane.showMessageDialog(this, "Wrong Phone number", "Input again", JOptionPane.ERROR_MESSAGE);
            jtfSDT.setText("");
            jtfSDT.requestFocus();
            return false;
        }
